...
if(seleccion == "si"){
	...
	do {
		let productoSeleccionado= prompt("Estos son nustros productos: "+producto1.nombre+", "+producto2.nombre+", "+producto3.nombre+", "+producto4.nombre+" Ingrese el que quiere sumar al carrito:")
